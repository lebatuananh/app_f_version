...
class _OnBoardingPageState extends State<OnBoardingPage> {
  ...
  //   return Image.asset(
  //     'assets/onboarding/fullscreen.jpg',
  //     fit: BoxFit.cover,
  ...
  Widget _buildImageLogo(String assetName, [double width = 350]) {
    return Image.asset('assets/brands/$assetName', width: width);
  }
      ...
      globalHeader: Align(
        ...
        child: SafeArea(
          child: Padding(
            ...
            child: _buildImageLogo('logo.png', 60),
          ),
        ),
      ),
