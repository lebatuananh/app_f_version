...
import 'package:futech_app/widgets/theme/app_theme_notifier.dart';
...
class CustomAppTheme {
  ...
  final Color cookifyPrimary, cookifyPrimaryGrey, cookifyOnPrimary;
  ...
  CustomAppTheme({
    ...
    this.cookifyPrimaryGrey = const Color(0xff1f1f1f),
